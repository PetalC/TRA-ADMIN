...
export const HEADER_NOTIFICATION_REDUX_CONSTANTS = {
  ...
  REPORT_EXPIRING: 'REPORT_EXPIRING',
  ALERT: 'ALERT',
  APPLICATION_APPROVED: 'APPLICATION_APPROVED',
  APPLICATION_DECLINED: 'APPLICATION_DECLINED',
  APPLICATION_GENERATED: 'APPLICATION_GENERATED',
  CLAIM_ADDED: 'CLAIM_ADDED',
  CREDIT_LIMIT_EXPIRING: 'CREDIT_LIMIT_EXPIRING',
  DUE_TASK: 'DUE_TASK',
  OFF_NOTIFIRE: 'OFF_NOTIFIRE',
  REVIEW_DEBTOR: 'REVIEW_DEBTOR',
  GET_NOTIFICATION_ALERTS_DETAILS: 'GET_NOTIFICATION_ALERTS_DETAILS',
  CLEAR_NOTIFICATION_ALERTS_DETAILS: 'CLEAR_NOTIFICATION_ALERTS_DETAILS',
  MARKED_ALL_AS_READ: 'MARKED_ALL_AS_READ',
  REPORT_NOTIFICATION: 'REPORT_NOTIFICATION',
  OVERDUE_BULKUPLOADED: 'OVERDUE_BULKUPLOADED'
};
