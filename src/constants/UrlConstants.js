...
export const APPLICATION_URLS = {
  ...
  APPLICATION_DROPDOWN_DATA_BY_SEARCH: `${BASE_URL}application/getEntityBySearch`,
...
export const CLIENT_URLS = {
  ...
  CLIENT_OVERDUE: {
    UPLOAD_OVERDUE_CSV: `${BASE_URL}overdue/upload-csv/`,
    ...
    DOWNLOAD_CLIENT_OVERDUE_LIST: `${BASE_URL}overdue/download/overdue-list/`
  },
  CLIENT_CLAIMS: {
